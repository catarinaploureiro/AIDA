...
#'   \item{\code{intData}}{An \linkS4class{intData} object, constructed using KDE for estimating the parameters of the latent distributions.}
#' }
#' 
#' @examples
...
#' Credit Card Dataset
#'
#' This dataset contains interval data of credit card expenses, including min-max values, centers and ranges, microdata, and an \linkS4class{intData} object.
...
#'   \item{\code{intData}}{An \linkS4class{intData} object with `36` interval-valued observations and `5` variables, constructed assuming the microdata follow symmetric triangular distributions.}
#' }
#' 
#' @examples
#' data(creditcard)
...
#'      \item{\code{intData_minmax}}{An \linkS4class{intData} object with `111` interval-valued observations and `11` variables, constructed using min-max aggregation based on the transformed microdata.}
#'      \item{\code{intData_trimmed}}{An \linkS4class{intData} object with `111` interval-valued observations and `11` variables, constructed using trimmed aggregation (`1\%` trimming) based on the transformed microdata.}
#' }
#' 
#' @examples
#' data(spotify_tracks)
...
#'  \item{\code{intData}}{An \linkS4class{intData} object with `27` interval-valued observations and `4` variables. The variable "Price" was log-transformed into "lnPrice". The microdata are not available, thus the default parameters of the latent distributions were used assuming a uniform distribution.}
#' }
#' 
#' @examples
#' data(intCars)
