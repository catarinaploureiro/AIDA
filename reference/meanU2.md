...
Obtain the mean of the square of the latent variables inherent to the
macrodata.
...
Either a diagonal matrix with the mean of the square of each variable or
a value if the variables are identically distributed.
