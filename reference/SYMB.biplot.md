...
Create a biplot for interval-valued symbolic data, visualizing the
...
A biplot is drawn in the graphic window. The biplot shows the symbolic
data as rectangles or crosses, with the first two variables on the x and
y axes.
