...
For more details on the interval-valued data framework implemented in the package, please refer to @oliveira2024.
...
for (i in 1:5){
    hist(credit_card_U[,i], xlab=NULL, ylab=NULL, main=colnames(credit_card_U)[i], probability=TRUE)
