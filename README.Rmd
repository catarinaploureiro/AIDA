...
[![GitHub Version](https://img.shields.io/badge/GitHub-v0.2.0-blue)](https://github.com/catarinaploureiro/AIDA)
...
For examples on explainable outlier detection using Shapley values (@loureiro2026b), see:
